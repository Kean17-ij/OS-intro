...
![sudo apt-get install libc6-dev-i386](Photos/4.png){ #fig:006 width=70% }
    ...
    Сначала у меня была проблема, когда я запустил команду cd / usr / include / sys, я не Мне удалось найти файл usr / include / sys /, поэтому я установил его с помощью
sudo apt-get install libc6-dev-i386, и тогда он сработал. 
